      ...
      <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-sm flex items-center gap-8">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm font-bold text-slate-400 mt-1 uppercase tracking-widest">
            {config?.teacher?.default_department || '物理学院'} · 教师
          </p>
          ...
          <div className="flex items-center gap-4 mt-4">
            ...
            <span className="px-4 py-1.5 bg-slate-50 text-slate-500 text-[10px] font-black uppercase tracking-widest rounded-full border border-slate-100">
              阅卷系统管理员
            </span>
          </div>
        </div>
        <button
          ...
          className="px-8 py-3 bg-brand text-white rounded-2xl font-black text-sm uppercase tracking-widest shadow-lg shadow-brand/20 hover:scale-105 transition-all"
        >
          编辑资料
        </button>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {[
                ...
                },
                {
                  ...
                  value:
                    user?.subject ||
                    config?.teacher?.default_subject ||
                    '大学物理',
                  icon: BookOpen,
                },
              ].map((item, i) => (
                <div
                  key={i}
                  className="p-5 bg-slate-50 rounded-2xl border border-slate-100 group hover:border-brand-light/50 transition-all"
                >
          ...
          <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm p-8 space-y-6">
            ...
            <div className="space-y-4">
              {[
                ...
                <div
                  key={i}
                  className="flex items-center justify-between p-5 bg-slate-50 rounded-2xl border border-slate-100 group hover:border-brand-light/50 transition-all cursor-pointer"
                >
                  ...
                  <span className="text-[10px] font-black text-slate-300 uppercase tracking-widest group-hover:text-brand transition-all">
                    修改 →
                  </span>
                </div>
              ))}
